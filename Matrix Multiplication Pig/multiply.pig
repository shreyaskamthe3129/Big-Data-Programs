matrixM = LOAD 'M-matrix-small.txt' USING PigStorage(',') AS (ithMIndex:long , jthMIndex:long , valueM:double);

matrixN = LOAD 'N-matrix-small.txt' USING PigStorage(',') AS (jthNIndex:long , kthNIndex:long , valueN:double);
